...
def add_recipe(
    table, nom, nombre_de_personne, temps_preparation, ingredients, instructions
):
    """
...
def get_recipes_by_category(category):
    ...
    cursor.execute(
        f"SELECT id, nom, nombre_de_personne, temps_preparation, ingredients, instructions FROM {category}"
    )
